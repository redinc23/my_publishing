...
> **Note (2026-07-19):** Root `CLAUDE.md` also marks Phoenix **PAUSED**. Until the owner
> confirms reactivation, do not open new Phoenix implementation PRs. Docs/recon retained.

### C0.4 Open-PR backlog triage (2026-07-19)

The “19 PRs” backlog was already integrated via #286–#288 / #289. Remaining open PRs
were triaged by agents: superseded drafts closed; main CI unblocked (newsletter mocks +
Prettier); Dependabot/action bumps + release-please handled separately. **Still human:**
C0.1 (disable storm automations) before enabling in-repo `ci-fix-loop.yml` (H0.2b).
