...
- [ ] **Errors:** Sentry is **optional / not implemented** (Next.js App Router — no `_app.tsx`; placeholder only in `components/common/ErrorBoundary.tsx`). Use Cloud Logging for now.
