...
> **SUPERSEDED (2026-07-18):** Amplify is not the launch production path. Canonical = **Vercel** ([ADR-001](./adr/ADR-001-canonical-platform.md) Option B). See [CANONICAL_PRODUCTION.md](./CANONICAL_PRODUCTION.md).
