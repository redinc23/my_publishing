...
Evidence: `app/(consumer)/book-clubs/page.tsx` already states “Book club creation is coming soon” and only links to live catalog/genres/readers-hub (verified 2026-07-20 @ `625f46d`).
...
Note: No further code change required; marked SHIPPED after SCOUT confirmation.
