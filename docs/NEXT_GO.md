...
| `docs/adr/ADR-001-canonical-platform.md`  | **present on main**                          | ADR-001 **RECOMMENDED** Option A (Phase 6); signatures required for ACCEPTED / G9 (P0-003)                                                                                                                                                                          |
...
| 6   | Canonical Platform Decision & Runbooks            | **IN PROGRESS**                         | ADR-001 **RECOMMENDED** Option A; monitors on apex (Lighthouse confirmed #227). **Blocked on signatures** for ACCEPTED/G9; `www` DNS cutover = Phase 15                                                                               |
...
| 10  | Observability, Sentry, Synthetic Monitoring       | **IN PROGRESS**                         | Health/Lighthouse retargeted to canonical apex (P0-007). Remaining: Sentry release-SHA event; alert routing confirmation                                                                                                              |
...
| P0-003 | Lock canonical platform/DNS authority in ADR-001              | 6, 15       | G9              | [#190](https://github.com/redinc23/my_publishing/issues/190) — **RECOMMENDED** Option A; needs signatures → ACCEPTED |
...
| P0-007 | Retarget health/Lighthouse monitors to canonical production   | 6, 10, 15   | G9              | [#186](https://github.com/redinc23/my_publishing/issues/186) — **DONE** (workflows + Lighthouse on apex); close OK   |
...
| G9   | ADR signed; monitors hit real production          | ADR-001 signed; DNS/monitor URLs canonical                        | ADR commit + monitor run URLs      | **FALSE** — monitors → apex; ADR RECOMMENDED not ACCEPTED; `www` still Vercel                            |
