...
| **Established by**           | Phase 1 authority PR #206 (`0f30649`) merged to main 2026-07-18 → **G13 TRUE**. v1.2.1 records Phase 4 Tier L local verification + post-#223 green CI on code tip `5744794` (CCR-020/G12 partial). |
...
| 5   | CI/CD Workflow Repair                             | **IN PROGRESS**                         | Format Check (#211); P0-006 trigger (`CI`); P0-005 BASE_URL semantics (#221); MCP route-export follow-up (#223) → CI green. Remaining: preview-E2E live confirm; bug-to-issue push-race (#225 draft); Cloud Build vuln-scan false positives (#225) |
