...
const AnalyticsOverview = dynamic(
  () => import('./AnalyticsOverview').then((m) => ({ default: m.AnalyticsOverview })),
  { ssr: false, loading: ChartFallback }
);
const ViewsChart = dynamic(() => import('./ViewsChart').then((m) => ({ default: m.ViewsChart })), {
  ssr: false,
  loading: ChartFallback,
});
const LiveReaders = dynamic(() => import('./LiveReaders'), { ssr: false, loading: ChartFallback });
const GeographyMap = dynamic(
  () => import('./GeographyMap').then((m) => ({ default: m.GeographyMap })),
  { ssr: false, loading: ChartFallback }
);
const EngagementHeatmap = dynamic(
  () => import('./EngagementHeatmap').then((m) => ({ default: m.EngagementHeatmap })),
  { ssr: false, loading: ChartFallback }
);
const RevenueStats = dynamic(
  () => import('./RevenueStats').then((m) => ({ default: m.RevenueStats })),
  { ssr: false, loading: ChartFallback }
);
