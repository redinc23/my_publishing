...
5. Remove dead code and commented blocks.
...
4. Validate auth and session handling.
5. Add CSRF protection where needed.
6. Ensure password hashing best practices.
7. Enforce strict CORS configuration.
...
6. Check auth guards on endpoints.
